...
# Does what bc-image-overlay does, but reads tiles, not images
...
// this is just cut and paste from gettile3.php (sigh)
...
print "<p>Source: https://github.com/barrycarter/bcapps/blob/master/MAPS/bc-image-from-tiles.pl<br>See also: https://github.com/barrycarter/bcapps/blob/master/MAPS/<br>\n";

print "</body></html>\n";

# TODO: add instructions re how to change zoom, map type, refresh,
# center, etc (to the actual page where this is displayed)
