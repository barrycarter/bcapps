...
TAG POS=1 TYPE=SELECT FORM=ACTION:BANGSearch.dll ATTR=NAME:Format CONTENT=%420
TAG POS=1 TYPE=SELECT FORM=ACTION:BANGSearch.dll ATTR=NAME:Subject CONTENT=%$i
TAG POS=1 TYPE=SELECT FORM=ACTION:BANGSearch.dll ATTR=NAME:PerPage CONTENT=%25
