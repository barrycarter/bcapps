...
m0 = {-2.493673284195151*10^7,1.330734168777016*10^8,5.764600356317691*10^7};
md0 = {-3.056658316901732*10^1,-4.207149336797371*10^0,-1.904942957747298};
mm = 7.34767309*10^22;
...
s''[t] == grav*em*(e[t]-s[t])/Norm[e[t]-s[t]]^3 +
          grav*mm*(m[t]-s[t])/Norm[m[t]-s[t]]^3,
e''[t] == grav*sm*(s[t]-e[t])/Norm[s[t]-e[t]]^3 +
          grav*mm*(m[t]-e[t])/Norm[m[t]-e[t]]^3,
