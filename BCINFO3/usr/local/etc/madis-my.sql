-- these queries are run after every madis update for MySQL
...
-- TODO: below two DELETEs do not work:
-- You can't specify target table 'madis' for update in FROM clause
-- above is a MySQL limitation
