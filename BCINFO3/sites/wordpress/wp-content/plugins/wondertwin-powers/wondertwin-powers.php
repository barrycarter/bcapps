...
function wt_filter($content) {
  ...
  // the semicolon below matches quotes (when HTML-escaped)
  $content=preg_replace_callback("%(\s|^|>|\;)(https?://[a-z0-9_\-\.\/\?\+\=\%\&\#\;]+)%i", "url_filter", $content);
